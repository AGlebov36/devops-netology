...
4. Подготовьте хосты в соответствии с группами из предподготовленного playbook. Создал виртуальную машину Centos 7 на 158.160.42.103
...
vector-01                  : ok=3    changed=1    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0 
```
